...
def sugerir_cardapio(tipo_de_evento, convidados):
    opcoes = {
        "casamento": {  
            "vegetariano": {
                "pequeno": [
                    ...
                    "Ravioli de Búfala ao Molho Sugo com Manjericão"
                ],
                "grande": [
        ...
        "corporativo": {  
            ...
            "vegano": {
                "pequeno": [
                    "Poke Bowl com Tofu, Manga, Pepino e Arroz Gohan",
                    "Wrap de Hummus com vegetais grelhados"
                ],
                "grande": [
        ...
        "generico": {  
            "vegetariano": {
                "pequeno": [
                    ...
                    "Omelete recheado com salada"
                ],
                "grande": [
                    "Massa Penne ao molho branco e vermelho", 
                    "Tortas Salgadas variadas"
                ]
            },
            "vegano": {
                "pequeno": [
                ...
                "grande": [
                    "Arroz carreteiro vegano (com legumes e soja)", 
                    "Salpicão vegano com maionese de batata"
                ]
            },
            "kosher": { #restrições judaícas
                "pequeno": [
                ...
                "grande": [
                    "Buffet de carnes assadas", 
                    "Sanduíches de carne fria"
                ]
            },
            "halal": { #restrições islâmicas
                "pequeno": [
                ...
                "grande": [
                    "Estrogonofe de carne (Halal) e batata palha", 
                    "Arroz temperado com frango desfiado"
                ]
            },
            "sem restricao": {
                "pequeno": [
                    "Jantar em restaurante reservado", 

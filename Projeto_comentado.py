...
while True:
    ...
    if options == '2':
        ...
        try:
            ...
            print()
            ipt=input().lower()
            if ipt in repositorio: #Verifica se a chave solicitada está no repositório
                ...
                if ipt1 == '1': #Se o cara quer trocar o nome do evento, eu salvo as "caracteristicas" em uma variavel e deleto o evento inteiro.
                    tipo = repositorio[ipt][0]
                    data = repositorio[ipt][1]
                    local = repositorio[ipt][2]
                    orca = repositorio[ipt][3]  
                ...
                elif ipt1 == '2': # A Partir daqui, só precisa alterar o tipo requisitado e não mudar a chave
